...
| `agentlessScanningHostSubscriptionId`                                         | no       | Azure agentless scanning host subscription ID. When set, cross-account mode is enabled where only the host subscription deploys full scanning infrastructure, while other subscriptions get role assignments and scanning parameters only.                                                                                                              |
