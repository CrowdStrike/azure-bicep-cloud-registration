...
|-------------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `csInfraSubscriptionId`                                                       | no       | Subscription ID where CrowdStrike infrastructure resources will be deployed. This subscription hosts shared resources like Event Hubs. Required when `logIngestionSettings.enabled` is set to `true`.     |
...
| `falconIpAddresses`                                                           | no       | Falcon public IP addresses. Only used when `logIngestionSettings.enabled` is set to `true`. These will be configured to public network access list of EventHubs.                                          |
