...
| `agentlessScanningDeployNatGateway`                                           | no       | Indicates Data Security Posture Management (DSPM) scanning environment will be deployed with NAT Gateway. Default is `true`.                                                                                                                                                                                                                           |
